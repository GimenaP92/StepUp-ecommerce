      ...
      <section>
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
          <header>
            ...
            ¡Descubre nuestra nueva colección de zapatillas deportivas! Diseñadas para ofrecerte comodidad y estilo. Encontrarás el par ideal para acompañarte en cada paso. 
            </p>
          </header>
            ...
            {products.map((product) => (
              <li key={product.id}>
                <a href={`/products/${product.id}`} className="group block overflow-hidden">
                  <img
                    src={product.image} // Asegúrate de que `product.image` tenga la URL correcta
                    alt={product.name}
